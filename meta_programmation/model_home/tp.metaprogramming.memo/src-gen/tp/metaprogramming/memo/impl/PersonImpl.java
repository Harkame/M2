 ...
 *   <li>{@link tp.metaprogramming.memo.impl.PersonImpl#getHas <em>Has</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PersonImpl extends NamedElementImpl implements Person {
	 ...
	 * @ordered
	 */
	protected EList<Automobile> has;
	 ...
	 * @generated
	 */
	public EList<Automobile> getHas() {
		if (has == null) {
			has = new EObjectContainmentEList<Automobile>(Automobile.class, this, MemoPackage.PERSON__HAS);
		}
		return has;
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case MemoPackage.PERSON__HAS:
			getHas().clear();
			getHas().addAll((Collection<? extends Automobile>) newValue);
			return;
		}
