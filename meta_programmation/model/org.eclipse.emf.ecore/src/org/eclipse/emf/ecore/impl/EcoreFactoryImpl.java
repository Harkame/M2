...
public class EcoreFactoryImpl extends EFactoryImpl implements EcoreFactory
{
  ...
  public EObject create(EClass eClass)
  {
		switch (eClass.getClassifierID()) {
			...
			case EcorePackage.EMEMO_CLASS: return createEMemoClass();
			case EcorePackage.MEMO_CLASS: return createMemoClass();
			default:
  ...
  /**
	 ...
	 * @generated
	 */
	public EMemoClass createEMemoClass() {
		EMemoClassImpl eMemoClass = new EMemoClassImpl();
		return eMemoClass;
	}
	 ...
	 * @generated
	 */
	public MemoClass createMemoClass() {
		MemoClassImpl memoClass = new MemoClassImpl();
		return memoClass;
	}
