...
public class EcoreAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected EcoreSwitch<Adapter> modelSwitch =
    new EcoreSwitch<Adapter>() {
			...
			@Override
			public Adapter caseEMemoClass(EMemoClass object) {
				return createEMemoClassAdapter();
			}
			@Override
			public Adapter caseMemoClass(MemoClass object) {
				return createMemoClassAdapter();
			}
			@Override
  ...
  /**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecore.EMemoClass <em>EMemo Class</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEMemoClassAdapter() {
		return null;
	}

		/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecore.MemoClass <em>Memo Class</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMemoClassAdapter() {
		return null;
	}
