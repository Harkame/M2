...
public class EcorePackageImpl extends EPackageImpl implements EcorePackage
{
  ...
  /**
	 ...
	 * @generated
	 */
	private EClass eMemoClassEClass = null;
  ...
  /**
	 ...
	 * @generated
	 */
	public EClass getEMemoClass() {
		return eMemoClassEClass;
	}
	 ...
	 * @generated
	 */
	public EAttribute getEMemoClass_Instances() {
		return (EAttribute)eMemoClassEClass.getEStructuralFeatures().get(0);
	}
  ...
  public void createPackageContents()
  {
		...
		eMemoClassEClass = createEClass(EMEMO_CLASS);
		createEAttribute(eMemoClassEClass, EMEMO_CLASS__INSTANCES);
  ...
  public void initializePackageContents()
  {
		...
		eMemoClassEClass.getESuperTypes().add(this.getEClass());
		memoClassEClass.getESuperTypes().add(this.getEClass());
		...
		initEClass(eMemoClassEClass, EMemoClass.class, "EMemoClass", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getEMemoClass_Instances(), ecorePackage.getEJavaObject(), "instances", null, 0, -1, EMemoClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, !IS_ORDERED);
